...
//           <div className="absolute bg-white flex flex-col items-center gap-2 px-4 py-2 rounded-xl top-0 right-24">
//             <img
...
//             </p>
//           </div>
//           <div className=" absolute bg-white flex flex-row items-center gap-2 px-4 py-2 rounded-xl bottom-0 left-24 ">
//             <img
//               src="./Group.png"
//               alt=""
//               className="bg-[#EDF5FE] p-2 rounded-full"
